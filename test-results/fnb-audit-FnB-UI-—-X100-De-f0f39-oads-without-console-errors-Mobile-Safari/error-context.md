...
- Name: fnb-audit.spec.ts >> FnB UI — X100 Deep Audit >> Thực đơn (/menu.html) >> page loads without console errors
...
+   "/127.0.0.1:8787/api/categories due to access control checks.",
+   "Failed to load resource: Could not connect to the server.",
+   "Could not connect to the server.",
+   "/127.0.0.1:8787/api/products?available=1 due to access control checks.",
+   "Failed to load resource: Could not connect to the server.",
+   "Failed to load resource: Could not connect to the server.",
+   "Failed to load resource: Could not connect to the server.",
+ ]
  ...
  - contentinfo [ref=e343]:
    - generic [ref=e344]:
      - generic [ref=e345]:
        ...
        - generic [ref=e349]:
          - link "Theo dõi AURA CAFE trên Facebook" [ref=e350]:
            - /url: https://facebook.com/auracafesadec
            - img [ref=e351]
          - link "Theo dõi AURA CAFE trên Instagram" [ref=e353]:
            - /url: https://instagram.com/auracafesadec
            - img [ref=e354]
          - link "Theo dõi AURA CAFE trên TikTok" [ref=e357]:
            - /url: https://tiktok.com/@auracafesadec
            - img [ref=e358]
          - link "Liên hệ AURA CAFE qua Zalo" [ref=e360]:
      ...
      - generic [ref=e364]:
        ...
        - link "Menu" [ref=e366]:
          - /url: menu.html
        - link "Không Gian" [ref=e367]:
          - /url: index.html#spaces
        - link "Đặt Bàn" [ref=e368]:
          - /url: table-reservation.html
      - generic [ref=e369]:
        - heading "Thành Viên" [level=5] [ref=e370]
        - link "Loyalty & Cashback" [ref=e371]:
          - /url: loyalty.html
        - link "Theo Dõi Đơn" [ref=e372]:
          - /url: track-order.html
      - generic [ref=e373]:
        - heading "Hỗ Trợ & Admin" [level=5] [ref=e374]
        - link "Liên Hệ" [ref=e375]:
          - /url: contact.html
        - link "About" [ref=e376]:
          - /url: about-us.html
        - link "Admin Dashboard" [ref=e377]:
