...
- Name: fnb-audit.spec.ts >> FnB UI — X100 Deep Audit >> Giới thiệu (/about-us.html) >> no FOVT — theme applied before paint
- Location: tests/playwright/fnb-audit.spec.ts:41:7
