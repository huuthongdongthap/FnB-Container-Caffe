...
- Name: fnb-audit.spec.ts >> FnB UI — X100 Deep Audit >> Giới thiệu (/about-us.html) >> no horizontal overflow on tablet (768px)
- Location: tests/playwright/fnb-audit.spec.ts:78:7
