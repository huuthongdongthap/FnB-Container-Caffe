...
- Name: fnb-audit.spec.ts >> FnB UI — X100 Deep Audit >> Liên hệ (/contact.html) >> no banned Fire/Earth color hex in computed styles
...
Error: page.goto: Could not connect to the server.
Call log:
  - navigating to "http://localhost:5173/contact.html", waiting until "load"
