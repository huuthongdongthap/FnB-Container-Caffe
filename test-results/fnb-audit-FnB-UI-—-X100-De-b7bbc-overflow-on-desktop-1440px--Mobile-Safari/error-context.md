...
- Name: fnb-audit.spec.ts >> FnB UI — X100 Deep Audit >> Giới thiệu (/about-us.html) >> no horizontal overflow on desktop (1440px)
- Location: tests/playwright/fnb-audit.spec.ts:86:7
