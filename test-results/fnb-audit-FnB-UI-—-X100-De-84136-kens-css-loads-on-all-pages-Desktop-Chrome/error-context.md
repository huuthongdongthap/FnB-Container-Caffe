...
- Name: fnb-audit.spec.ts >> FnB UI — X100 Deep Audit >> Cross-page consistency >> brand-tokens.css loads on all pages
- Location: tests/playwright/fnb-audit.spec.ts:128:5
...
Locator:  locator('link[href*="brand-tokens.css"]')
Expected: 1
Received: 2
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('link[href*="brand-tokens.css"]')
