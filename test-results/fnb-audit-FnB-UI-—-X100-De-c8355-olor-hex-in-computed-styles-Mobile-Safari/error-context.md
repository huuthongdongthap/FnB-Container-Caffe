...
- Name: fnb-audit.spec.ts >> FnB UI — X100 Deep Audit >> Giới thiệu (/about-us.html) >> no banned Fire/Earth color hex in computed styles
- Location: tests/playwright/fnb-audit.spec.ts:52:7
...
Error: page.goto: Could not connect to the server.
Call log:
  - navigating to "http://localhost:5173/about-us.html", waiting until "load"
