...
import type { ZnsData } from 'worker/src/tree/zalo/types';
import { sendSMS } from 'worker/src/lib/speedsms-client';
import type { SpeedSMSEnv } from 'worker/src/lib/speedsms-client';
