...
CREATE TABLE loyalty_tiers (
    ...
    created_at      TEXT DEFAULT (datetime('now'))
, display_name_vi TEXT, min_spent_vnd INTEGER DEFAULT 0, max_spent_vnd INTEGER, expiry_days INTEGER, sort_order INTEGER DEFAULT 0);
INSERT INTO "loyalty_tiers" ("tier_name","min_points","cashback_rate","point_multiplier","birthday_discount","created_at","display_name_vi","min_spent_vnd","max_spent_vnd","expiry_days","sort_order") VALUES('bronze',0,0.03,1,10,'2026-05-18 09:53:17','Đồng',0,500000,90,1);
INSERT INTO "loyalty_tiers" ("tier_name","min_points","cashback_rate","point_multiplier","birthday_discount","created_at","display_name_vi","min_spent_vnd","max_spent_vnd","expiry_days","sort_order") VALUES('silver',50,0.05,1.2,20,'2026-05-18 09:53:17','Bạc',500000,2000000,120,2);
INSERT INTO "loyalty_tiers" ("tier_name","min_points","cashback_rate","point_multiplier","birthday_discount","created_at","display_name_vi","min_spent_vnd","max_spent_vnd","expiry_days","sort_order") VALUES('gold',200,0.07,1.5,35,'2026-05-18 09:53:17','Vàng',2000000,5000000,180,3);
INSERT INTO "loyalty_tiers" ("tier_name","min_points","cashback_rate","point_multiplier","birthday_discount","created_at","display_name_vi","min_spent_vnd","max_spent_vnd","expiry_days","sort_order") VALUES('platinum',500,0.1,2,50,'2026-05-18 09:53:17','Bạch Kim',5000000,NULL,NULL,4);
...
CREATE TABLE cashback_transactions (
    ...
    description     TEXT,
    created_at      TEXT DEFAULT (datetime('now'))
, expires_at TEXT, multiplier_applied REAL DEFAULT 1.0, campaign_id INTEGER, customer_id TEXT, staff_id TEXT);
...
INSERT INTO "bonus_campaigns" ("id","code","name","description","start_date","end_date","cashback_multiplier","signup_bonus_vnd","signup_bonus_cap","refer_bonus_vnd","max_cap_per_customer_vnd","auto_upgrade_tier","auto_upgrade_min_spend","active","created_at") VALUES(1,'GRAND_OPENING_6_6_2026','Khai trương AURA CAFE 06/06','Cashback x2 + Signup +50k cho 100 người đầu + Refer +50k + Auto-upgrade Silver khi spend >=200k ngày 6/6','2026-06-06 00:00:00','2026-06-08 23:59:59',2,50000,100,50000,100000,'silver',200000,1,'2026-05-18 09:53:17');
CREATE TABLE signup_bonus_log (
    id              INTEGER PRIMARY KEY AUTOINCREMENT,
    customer_id     TEXT NOT NULL,
...
INSERT INTO "sqlite_sequence" ("name","seq") VALUES('bonus_campaigns',1);
...
CREATE INDEX idx_cbtxn_customer ON cashback_transactions(customer_id);
CREATE INDEX idx_cbtxn_expires ON cashback_transactions(expires_at);
CREATE INDEX idx_cbtxn_order_type ON cashback_transactions(order_id, type);
CREATE UNIQUE INDEX idx_cbtxn_order_earn_unique
  ON cashback_transactions(order_id, type)
  WHERE type = 'earn' AND order_id IS NOT NULL;
CREATE INDEX idx_campaigns_active_dates ON bonus_campaigns(active, start_date, end_date);
CREATE INDEX idx_signup_bonus_campaign ON signup_bonus_log(campaign_id, granted_at);
CREATE INDEX idx_audit_customer_date ON loyalty_audit_log(customer_id, created_at);
CREATE INDEX idx_audit_action_date ON loyalty_audit_log(action, created_at);
