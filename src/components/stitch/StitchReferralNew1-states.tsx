      ...
      <div className="px-5 pb-32 pt-20" role="status" aria-label={t('stitch.referral.loadingAria')}>
        <div className="mb-10 mt-2">
          <div className="relative overflow-hidden rounded-xl p-6 text-center backdrop-blur-[8px]" style={{background: 'color-mix(in srgb, var(--aura-surface-container) 40%, transparent)'}}>
            <div className="mx-auto mb-1 h-4 w-24 animate-pulse rounded bg-[rgba(var(--aura-glass-bg),0.08)]" />
            <div className="mx-auto mb-1 h-12 w-44 animate-pulse rounded bg-[rgba(var(--aura-glass-bg),0.08)]" />
            <div className="mx-auto h-4 w-56 animate-pulse rounded bg-[rgba(var(--aura-glass-bg),0.08)]" />
          </div>
        </div>
        ...
        <div className="mb-10">
          <div className="mb-3 h-4 w-36 animate-pulse rounded bg-[rgba(var(--aura-glass-bg),0.08)]" />
        ...
        <div className="flex flex-col gap-3">
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="flex items-center gap-3 rounded-xl p-3" style={{background: 'color-mix(in srgb, var(--aura-surface-container) 40%, transparent)'}}>
              <div className="h-10 w-10 animate-pulse rounded-lg bg-[rgba(var(--aura-glass-bg),0.08)]" />
              <div className="flex-1 space-y-1">
                <div className="h-4 w-24 animate-pulse rounded bg-[rgba(var(--aura-glass-bg),0.08)]" />
                <div className="h-3 w-32 animate-pulse rounded bg-[rgba(var(--aura-glass-bg),0.08)]" />
              </div>
            </div>
          ))}
        </div>
...
export function ReferralError({ message }: { message: string }) {
  ...
  return (
    ...
    >
      ...
      <h3 className="font-display text-xl font-semibold text-[var(--aura-chrome-bright, #E8EEF3)]">
