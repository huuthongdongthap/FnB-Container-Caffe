...
function OrderDashStatusBadge({ status }: { status: DashOrderItem['status'] }) {
  ...
  const config = {
    preparing: {
      ...
      class:
        'bg-[rgba(255,183,121,0.1)] text-[var(--aura-chrome-bright)] border border-[rgba(255,183,121,0.2)]',
    },
    delivered: {
      label: t('stitch.accountDashboard.statusDelivered', 'Delivered'),
      class:
        'bg-[rgba(184,199,226,0.1)] text-[var(--aura-chrome-bright)] border border-[rgba(184,199,226,0.2)]',
    },
  };
