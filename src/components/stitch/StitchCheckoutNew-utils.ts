...
export const inputClasses =
  'bg-[var(--aura-surface-container)] border-b border-[color-mix(in_srgb,var(--aura-chrome-dim)_30%,transparent)] focus:border-[var(--aura-chrome-bright)] px-4 py-3 text-[var(--aura-chrome-bright, #e5e2e1)] transition-all rounded-t-sm placeholder:text-[color-mix(in_srgb,var(--aura-chrome-soft)_50%,transparent)]';
