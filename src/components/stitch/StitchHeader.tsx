...
const mockData = {
  navLinks: [
    ...
    { label: 'Khong Gian', href: '#zones' },
    { label: 'Dat Ban', href: '#booking' },
  ],
  logoSrc:
...
export default function StitchHeader({ logoSrc = mockData.logoSrc }: Readonly<StitchHeaderProps>) {
    ...
    >
      <div className="flex justify-between items-center px-[24px] max-w-[1280px] mx-auto">
        ...
        <div className="flex items-center gap-4">
          ...
          />
          <span className="hidden md:block text-[clamp(2.5rem,8vw,3rem)] tracking-widest text-[#b8c7e2] uppercase font-['EB_Garamond',serif] leading-[1.2] font-medium">
            AURA CAFE
          </span>
        </div>
        ...
        {/* CTA */}
        <button className="bg-gradient-to-br from-[#e0e0e0] via-[#a0a0a0] to-[#c0c0c0] text-black text-sm tracking-[0.1em] font-semibold px-6 py-3 font-['Space_Grotesk',sans-serif] hover:opacity-80 transition-opacity">
          Dat Ban Ngay
        </button>
      </div>
    </nav>
