...
export function StitchLandingNew({
  ...
  return (
    <div
      className="relative min-h-screen bg-[#081425] text-[#d8e3fb] font-['Space_Grotesk',sans-serif] overflow-x-hidden"
      aria-label={t('landing.pageAriaLabel')}
    >
      {/* Navigation */}
      <nav
        className="fixed top-0 w-full z-50 flex justify-between items-center px-5 md:px-16 py-4 bg-[#081425]/15 backdrop-blur-xl border-b border-[#44474d]/30"
        aria-label={t('landing.navAriaLabel')}
      >
        <div className="font-['EB_Garamond',serif] text-[clamp(1.25rem,4vw,2rem)] text-[#d8e3fb] tracking-tight font-medium">
          AURA CAFE
        </div>
        <div className="hidden md:flex items-center gap-10">
          <a
            href="#menu"
            className="font-['EB_Garamond',serif] text-[24px] leading-[1.4] font-semibold text-[#efbd8a] border-b-2 border-[#efbd8a] pb-1"
          >
            {t('nav.menu')}
          </a>
          <a
            href="#reservation"
            className="font-['EB_Garamond',serif] text-[24px] leading-[1.4] font-semibold text-[#c5c6cd] hover:text-[#d8e3fb] transition-colors"
          >
        ...
        <button
          className="bg-gradient-to-br from-[#D4A574] to-[#B48554] text-[#2c1700] px-6 py-2 text-xs tracking-[0.1em] font-semibold font-['Space_Grotesk',sans-serif] uppercase active:opacity-80 active:scale-95 transition-all duration-300"
      ...
      <main className="relative pt-24 min-h-screen">
        ...
        />
        <div
          className="absolute bottom-1/4 -left-24 w-96 h-96 bg-[#b8c7e2]/10 rounded-full blur-[120px]"
          aria-hidden="true"
        />
        ...
        >
          <div className="relative bg-[rgba(148,163,184,0.1)] backdrop-blur-xl p-12 md:p-24 max-w-5xl w-full border border-transparent overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center">
              <p className="text-xs tracking-[0.4em] uppercase text-[#efbd8a] mb-6 font-['Space_Grotesk',sans-serif] font-semibold">
                {t('landing.heroTagline')}
              </p>
              <h1 className="font-['EB_Garamond',serif] text-[clamp(2.5rem,10vw,4rem)] text-[#d8e3fb] mb-8 max-w-3xl leading-[1.1] tracking-[-0.02em] font-medium">
                {t('landing.heroTitle')}
              </h1>
              <p className="text-lg md:text-[18px] leading-[1.6] text-[#c5c6cd] max-w-2xl mb-12 font-['Space_Grotesk',sans-serif]">
                {t('landing.heroDescription')}
              </p>
              <div className="flex flex-col sm:flex-row gap-6">
                <button
                  className="bg-gradient-to-br from-[#D4A574] to-[#B48554] text-[#0c1c30] px-10 py-5 text-xs tracking-[0.1em] font-semibold font-['Space_Grotesk',sans-serif] uppercase flex items-center gap-3 hover:shadow-[0_0_30px_rgba(212,165,116,0.35)] transition-all duration-500"
                ...
                <button
                  className="bg-transparent border border-[#8e9097] px-10 py-5 text-xs tracking-[0.1em] font-semibold font-['Space_Grotesk',sans-serif] uppercase text-[#d8e3fb] hover:bg-[#2a3548]/30 transition-all"
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              <div className="w-12 h-12 flex items-center justify-center mb-8 border border-[#efbd8a]/30 shadow-[0_0_20px_rgba(212,165,116,0.15)]">
                <Coffee className="w-5 h-5 text-[#efbd8a]" aria-hidden="true" />
              </div>
              <h3 className="font-['EB_Garamond',serif] text-[24px] leading-[1.4] font-semibold mb-4 text-[#d8e3fb]">
                {t('landing.featureMenuTitle')}
              </h3>
              <p className="text-sm leading-relaxed text-[#c5c6cd] mb-8 font-['Space_Grotesk',sans-serif]">
                {t('landing.featureMenuDesc')}
              </p>
              <a
                href="#menu"
                className="text-xs tracking-[0.1em] uppercase font-semibold font-['Space_Grotesk',sans-serif] text-[#efbd8a] group-hover:underline flex items-center gap-2"
        ...
        <section
          className="relative z-10 px-5 md:px-16 py-24 bg-[#040e1f]/50"
        ...
        >
          <div className="flex flex-col md:flex-row gap-20 items-center">
            ...
            <div className="w-full md:w-1/2 relative">
              ...
              <div className="absolute -bottom-10 -right-10 w-48 h-48 hidden md:block bg-[rgba(148,163,184,0.1)] backdrop-blur-xl p-4 border-t border-[#efbd8a]/20">
                <div
                  className="w-full h-full bg-cover bg-center"
            ...
            <div className="w-full md:w-1/2">
              <p className="text-xs tracking-[0.4em] uppercase text-[#efbd8a] mb-4 font-['Space_Grotesk',sans-serif] font-semibold">
                {t('landing.gallerySubtitle')}
              </p>
              <h2 className="font-['EB_Garamond',serif] text-[clamp(2rem,5vw,3rem)] leading-[1.2] tracking-[-0.01em] font-medium text-[#d8e3fb] mb-8">
                {t('landing.galleryTitle')}
              </h2>
              <p className="text-lg leading-[1.6] text-[#c5c6cd] mb-10 font-['Space_Grotesk',sans-serif]">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  />
                  <div>
                    <h4 className="text-xs tracking-[0.1em] uppercase font-semibold font-['Space_Grotesk',sans-serif] text-[#d8e3fb] mb-1">
                      {t('landing.galleryBullet1Title')}
                    </h4>
                    <p className="text-sm text-[#c5c6cd] font-['Space_Grotesk',sans-serif]">
          ...
          <div className="relative bg-[rgba(148,163,184,0.1)] backdrop-blur-xl p-8 md:p-12 border border-white/10">
            <div className="flex flex-col md:flex-row justify-between items-center gap-12">
              <div className="max-w-md w-full">
                <h2 className="font-['EB_Garamond',serif] text-[clamp(1.5rem,4vw,2rem)] leading-[1.3] font-medium text-[#d8e3fb] mb-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4 text-[#c5c6cd]">
                    ...
                    <span className="text-base leading-[1.6] font-['Space_Grotesk',sans-serif]">
      ...
      {/* Footer */}
      <footer
        className="w-full border-t border-[#44474d]/20 bg-[#081425] mt-20"
      ...
      >
        <div className="flex flex-col md:flex-row justify-between items-center px-5 md:px-16 py-12 w-full gap-8">
          <div className="flex flex-col gap-4">
            <div className="font-['EB_Garamond',serif] text-[24px] leading-[1.4] font-semibold text-[#d8e3fb]">
              AURA CAFE
            </div>
            <p className="text-sm leading-relaxed text-[#c5c6cd] max-w-xs uppercase tracking-widest opacity-60">
          ...
          <div className="flex flex-wrap justify-center gap-8 md:gap-12">
            <a
              href="#contact"
              className="text-sm leading-relaxed text-[#c5c6cd] hover:text-[#efbd8a] transition-colors uppercase tracking-wider font-['Space_Grotesk',sans-serif]"
          ...
          <div className="text-sm leading-relaxed text-[#c5c6cd] opacity-60 text-center md:text-left">
