...
const NAV_LINKS = [
  { key: 'menu', href: '#menu', labelKey: 'stitch.referral.navMenu', icon: MenuIcon },
  { key: 'referrals', href: '#referrals', labelKey: 'stitch.referral.navReferrals', icon: GroupAddIcon, active: true },
  { key: 'rewards', href: '#rewards', labelKey: 'stitch.referral.navRewards', icon: MedalIcon },
  { key: 'profile', href: '#profile', labelKey: 'stitch.referral.navProfile', icon: PersonIcon },
] as const;
