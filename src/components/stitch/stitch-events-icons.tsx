/**
 * Shared SVG icon components used across StitchEventsNew2 sub-components.
 * Extracted to avoid duplicating icon definitions in each component file.
 */
...
export function ScheduleIcon({ className = 'h-4 w-4' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} aria-hidden="true">
...
export function RestaurantIcon({ className = 'h-4 w-4' }: { className?: string }) {
  return (
...
export function BookTableIcon({ className = 'h-4 w-4' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
      <circle cx="12" cy="12" r="10" />
