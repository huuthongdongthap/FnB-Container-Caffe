...
export function MenuItemCard({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-[color-mix(in srgb,var(--aura-chrome-light,rgba(var(--aura-chrome-light),1)) 5%,transparent)] to-[rgba(0,0,0,0.35)]" />
