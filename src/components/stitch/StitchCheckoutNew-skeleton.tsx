      ...
      <div className="mx-auto max-w-7xl px-10 space-y-12">
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-12">
          <div className="space-y-10 lg:col-span-7">
            <div className="rounded-xl p-6 space-y-6 bg-[color-mix(in_srgb,var(--aura-surface-container)_75%,transparent)] backdrop-blur-[8px] border border-[rgba(var(--aura-chrome-light),0.15)]">
          ...
          <div className="lg:col-span-5">
            <div className="rounded-xl p-8 space-y-6 bg-[color-mix(in_srgb,var(--aura-surface-container)_75%,transparent)] backdrop-blur-[8px] border border-[rgba(var(--aura-chrome-light),0.15)]">
