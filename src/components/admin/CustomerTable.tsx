        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-gray-200">
              <th className="text-left py-2 px-3 font-medium text-gray-500 uppercase text-xs tracking-wider">Tên</th>
              <th className="text-left py-2 px-3 font-medium text-gray-500 uppercase text-xs tracking-wider">SĐT</th>
              <th className="text-center py-2 px-3 font-medium text-gray-500 uppercase text-xs tracking-wider">Đơn hàng</th>
              <th className="text-right py-2 px-3 font-medium text-gray-500 uppercase text-xs tracking-wider">Tổng chi</th>
              <th className="text-center py-2 px-3 font-medium text-gray-500 uppercase text-xs tracking-wider">Hạng</th>
              <th className="text-center py-2 px-3 font-medium text-gray-500 uppercase text-xs tracking-wider">Gần nhất</th>
            </tr>
          </thead>
          <tbody>
