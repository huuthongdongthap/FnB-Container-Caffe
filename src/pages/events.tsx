...
export function EventsPage() {
 ...
 AURA CAFE
 <br />
 <span className="text-[#b8c7e2]">Su Kien &amp; Dat Cho</span>
 </h1>
 ...
 <h2 className="mb-3 font-[EB_Garamond,serif] text-3xl font-bold">Lich Su Kien &amp; Workshop</h2>
 ...
 <h2 className="mb-3 font-[EB_Garamond,serif] text-3xl font-bold">
 ...
 <h2 className="mb-3 font-[EB_Garamond,serif] text-3xl font-bold">Lich Hoat Dong Hang Tuan</h2>
 <p className="mx-auto max-w-md text-sm text-[#b8c7e2]/60">
