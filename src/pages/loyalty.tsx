    ...
    <main className="mx-auto max-w-6xl px-4 py-24">
      ...
      <section id="tiers" className="mb-16">
        <div className="mb-12 text-center">
          ...
          <h2 className="mb-3 font-display text-3xl font-bold">4 Hang — Cang Uong Cang Loi</h2>
      ...
      <section className="mb-16 rounded-2xl bg-gradient-to-b from-muted/5 to-transparent px-4 py-12">
        <div className="mx-auto max-w-4xl">
          <div className="mb-12 text-center">
            ...
            <h2 className="mb-3 font-display text-3xl font-bold">Moi Ly — Mot Diem</h2>
            <p className="mx-auto max-w-md text-sm text-muted/60">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <Card className="p-6 text-center">
              ...
              <h4 className="font-display text-base font-bold">Mua Tai Quan</h4>
            ...
            <Card className="p-6 text-center">
              <span className="mb-3 block text-3xl">&#128591;</span>
              <h4 className="font-display text-base font-bold">Check-In</h4>
              <p className="mt-1 text-xs text-muted/60">
            ...
            <Card className="p-6 text-center">
              <span className="mb-3 block text-3xl">&#127874;</span>
              <h4 className="font-display text-base font-bold">Sinh Nhat</h4>
              <p className="mt-1 text-xs text-muted/60">
            ...
            <Card className="p-6 text-center">
              <span className="mb-3 block text-3xl">&#128279;</span>
              <h4 className="font-display text-base font-bold">Gioi Thieu Ban Be</h4>
              <p className="mt-1 text-xs text-muted/60">
      ...
      <section id="rewards" className="mb-16">
        <div className="mb-12 text-center">
          ...
          <h2 className="mb-3 font-display text-3xl font-bold">Doi Diem — Nhan Qua</h2>
          <p className="mx-auto max-w-md text-sm text-muted/60">
      ...
      {/* Calculator CTA */}
      <section className="mb-16">
        <Card className="mx-auto max-w-lg border border-accent/30 p-10 text-center">
