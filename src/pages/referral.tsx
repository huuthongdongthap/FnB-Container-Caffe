    ...
    <main className="mx-auto max-w-4xl px-4 py-24">
      ...
      <section id="how-it-works" className="mb-16">
        <div className="mb-12 text-center">
          ...
          <h2 className="mb-3 font-display text-3xl font-bold">3 Buoc Don Gian</h2>
        ...
        <div className="relative grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <Card className="relative p-6 text-center">
            <div className="mx-auto mb-5 flex h-20 w-20 items-center justify-center rounded-full border border-accent/20 bg-accent/5">
              <span className="text-3xl">&#128279;</span>
              <span className="absolute -right-1 -top-1 flex h-6 w-6 items-center justify-center rounded-full bg-accent text-xs font-bold text-background">
                1
              </span>
            </div>
            <h3 className="font-display text-lg font-bold">Chia Se Ma Cua Ban</h3>
          ...
          <Card className="relative p-6 text-center">
            ...
            <h3 className="font-display text-lg font-bold">Ban Be Dang Ky</h3>
            <p className="mt-2 text-sm text-muted/60">
          ...
          <Card className="relative p-6 text-center">
            ...
            <h3 className="font-display text-lg font-bold">Nhan Qua Tu Dong</h3>
            <p className="mt-2 text-sm text-muted/60">
      ...
      <section id="referral-code" className="mb-16">
        <div className="mb-12 text-center">
          ...
          <h2 className="mb-3 font-display text-2xl font-bold">Ma Cua Ban</h2>
        </div>
      ...
      <section id="rewards" className="mb-16">
        <div className="mb-12 text-center">
          ...
          <h2 className="mb-3 font-display text-2xl font-bold">Qua Tang Cho Nguoi Gioi Thieu</h2>
        </div>
        ...
        <p className="mx-auto mt-8 max-w-lg text-center text-xs text-muted/40">
