  ...
  return (
    <section className="py-32 px-5 md:px-16 max-w-[1280px] mx-auto overflow-hidden">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Value 1: Purity */}
        <div className="bg-white/5 backdrop-blur-[8px] border border-white/10 rounded-[40px] p-10 md:p-12 flex flex-col items-center text-center group">
        ...
        {/* Value 2: Integrity */}
        <div className="bg-white/5 backdrop-blur-[8px] border border-white/10 rounded-[40px] p-10 md:p-12 flex flex-col items-center text-center group relative overflow-hidden">
