...
function StitchShell({ children }: { children: React.ReactNode }) {
  return (
...
function Features({ revealed, setRef }: { revealed: Set<number>; setRef: (i: number, el: HTMLElement | null) => void }) {
  return (
    <section
      ref={(el) => setRef(1, el)}
...
function Atmosphere({ revealed, setRef }: { revealed: Set<number>; setRef: (i: number, el: HTMLElement | null) => void }) {
  return (
    <section
      ref={(el) => setRef(2, el)}
...
function MenuTeaser({ revealed, setRef }: { revealed: Set<number>; setRef: (i: number, el: HTMLElement | null) => void }) {
  return (
    <section
      ref={(el) => setRef(3, el)}
      className={`py-32 px-5 md:px-16 max-w-[1280px] mx-auto transition-all duration-1000 ${
