export function BottomNav() {
  return (
    <nav className="fixed bottom-0 left-0 w-full z-50 bg-[var(--aura-surface-container)]/10 backdrop-blur-[8px] border-t border-chrome/20 flex justify-around items-center px-6 pb-4 pt-2 rounded-t-full">
      ...
      <a href="#" className="flex flex-col items-center justify-center text-[var(--aura-tertiary)] pt-2 relative">
        <div className="absolute -top-1 w-8 h-[2px] bg-[var(--aura-tertiary)]" style={{ boxShadow: '0 0 8px var(--aura-primary)' }} />
