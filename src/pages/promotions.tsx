    ...
    <main className="mx-auto max-w-5xl px-4 py-24">
      ...
      <section className="mb-12 text-center">
        ...
        <h1 className="mb-4 font-display text-4xl font-bold md:text-5xl">
          Ma <span className="text-accent">Giam Gia</span> Doc Quyen
        </h1>
      ...
      {isError && (
        <Card className="p-10 text-center">
          ...
          <button
            type="button"
            onClick={() => refetch()}
            className="rounded-full border border-accent/40 px-6 py-2 text-sm text-accent transition-all hover:bg-accent/10"
          >
            Thu lai
          </button>
        </Card>
      ...
      {!isLoading && !isError && (!promotions || promotions.length === 0) && (
        <Card className="p-10 text-center">
          ...
          <p className="text-sm text-muted/60">Quay lai sau de cap nhat uu dai moi nhat nhe!</p>
        </Card>
      )}
        ...
        <Card className="p-8 text-center">
          ...
          <div className="mx-auto grid max-w-3xl grid-cols-1 gap-6 md:grid-cols-3">
            <div>
              ...
              <p className="mt-1 text-xs text-muted/60">Chon ma giam gia phu hop va bam &quot;Sao chep&quot;</p>
            </div>
            <div>
              <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-accent/10 text-lg font-bold text-accent">
                2
              ...
              <p className="mt-1 text-xs text-muted/60">Chon mon yeu thich tu menu cua AURA SPACE</p>
            </div>
            <div>
              <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-accent/10 text-lg font-bold text-accent">
                3
              ...
              <p className="mt-1 text-xs text-muted/60">Dan ma vao o &quot;Ma giam gia&quot; khi thanh toan</p>
            </div>
          </div>
        </Card>
      </section>
