      ...
      <div className="min-h-screen bg-gradient-to-b from-[#050D1A] via-[#0A1A2E] to-[#0F172A]">
        <div className="mx-auto max-w-6xl px-4 py-12">
          ...
          <div className="mb-10 text-center">
            <h1 className="font-display text-3xl font-bold text-chrome-bright sm:text-4xl">
            ...
            <div className="mb-10">
              <div className="mx-auto flex max-w-md items-center justify-center gap-8 rounded-2xl border border-white/5 bg-white/5 px-8 py-6">
                <div className="text-center">
                  <p className="font-display text-4xl font-bold text-chrome-bright">
          ...
          {!reviewsLoading && !reviewsError && reviews.length === 0 && (
            <div className="py-16 text-center">
              ...
              <p className="mt-4 font-display text-xl font-semibold text-chrome-bright">
