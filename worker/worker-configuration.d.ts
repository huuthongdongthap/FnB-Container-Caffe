/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 001078c8873da128a7b3ff962f3e3ece)
...
declare namespace Cloudflare {
	interface Env {
		...
		LLM_API_KEY: string;
		LLM_MODEL: string;
		WORKER_SELF_REFERENCE: Fetcher /* sophia-ai-factory */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_IS_CONFIGURED" | "IS_CONFIGURED" | "LLM_BASE_URL" | "LLM_API_KEY" | "LLM_MODEL">> {}
}
