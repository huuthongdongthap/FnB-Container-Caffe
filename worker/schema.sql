...
-- ═══════════════════════════════════════════════════════════════════════════════
-- INVENTORY MANAGEMENT SYSTEM (G5) — dev/local mirror
-- Source of truth: db/migrations/20260705_10_inventory_schema.sql
-- Apply production: wrangler d1 execute AURA_DB --file=db/migrations/20260705_10_inventory_schema.sql
-- ═══════════════════════════════════════════════════════════════════════════════
