/**
 * Welcome Email Template — gửi khi khách đăng ký tài khoản mới
 *
 * @param {object} customer
 * @param {string} customer.name — Customer display name
 * @param {string} [customer.loyalty_tier] — Optional loyalty tier
...
export function renderWelcome(customer) {
  const tierLabels = { basic: 'Thành viên', premium: 'Premium', enterprise: 'Enterprise', master: 'Master' };
